...
func _make_commands_node() -> AlephVault__MMO__Client.ConnectionCommands:
	...
	return AlephVault__MMO__Client.ConnectionCommands.new()
...
func _make_notifications_node() -> AlephVault__MMO__Client.ConnectionNotifications:
	...
	return AlephVault__MMO__Client.ConnectionNotifications.new()

var _commands: AlephVault__MMO__Client.ConnectionCommands
var _notifications: AlephVault__MMO__Client.ConnectionNotifications
var _connections: AlephVault__MMO__Client.Connections

## Gets the commands node from the connection.
var commands: AlephVault__MMO__Client.ConnectionCommands:
	get:
		return _commands
	set(value):
...
var notifications: AlephVault__MMO__Client.ConnectionNotifications:
	get:
