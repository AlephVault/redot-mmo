...
class_name AlephVault__MMO__Client
...
const Protocols = preload("./protocols.gd")
const Protocol = preload("./protocols/protocol.gd")
const ProtocolCommands = preload("./protocols/commands.gd")
const ProtocolNotifications = preload("./protocols/notifications.gd")
