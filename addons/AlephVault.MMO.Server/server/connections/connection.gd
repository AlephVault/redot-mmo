...
func _make_commands_node() -> AlephVault__MMO__Server.ConnectionCommands:
	...
	return AlephVault__MMO__Server.ConnectionCommands.new()
...
func _make_notifications_node() -> AlephVault__MMO__Server.ConnectionNotifications:
	...
	return AlephVault__MMO__Server.ConnectionNotifications.new()

var _commands: AlephVault__MMO__Server.ConnectionCommands
var _notifications: AlephVault__MMO__Server.ConnectionNotifications
var _connections: AlephVault__MMO__Server.Connections

## Gets the commands node from the connection.
var commands: AlephVault__MMO__Server.ConnectionCommands:
	get:
		return _commands
	set(value):
...
var notifications: AlephVault__MMO__Server.ConnectionNotifications:
	get:
