...
This package defines a standard structure for Multiplayer API-related nodes, their authorities, and the scopes
of communication between the different parties.
