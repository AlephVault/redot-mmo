...
var client = preload("res://addons/AlephVault.MMO.Samples/samples/scenes/sample-client.tscn")
var server = preload("res://addons/AlephVault.MMO.Samples/samples/scenes/sample-server.tscn")
